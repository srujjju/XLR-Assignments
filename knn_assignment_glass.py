...
X = replace_outliers_with_median(X_SS, X_SS.columns)
...
lb = LabelBinarizer()
lb.fit(y_train)  # Fit the label binarizer on the training labels
y_pred_train_prob = lb.transform(y_pred_train)
y_pred_test_prob = lb.transform(y_pred_test)

# Now calculate log loss using probabilities
